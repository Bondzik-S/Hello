...
// Об'єктизручніші в використанні, ніж масиви. На відміну від масивів, в об'єктах ми створюємо певні ключі, що спрощують процес звернення до об'єкту.
...
document.write(Object.keys(house)); // Виводитиме масив із властивостями об'єкту